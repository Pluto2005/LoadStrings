...
Main.Size = UDim2.new(0, 572, 0, 357)
...
function section:Label(text)
  ...
  return TextLabel
    ...
    function section.Toggle(section, text, flag, enabled, callback)
      ...
      ToggleDisable.BackgroundColor3 = Color3.fromRGB(106, 108, 106)
      ...
      local funcs = {
        SetState = function(self, state)
          ...
          services.TweenService:Create(ToggleSwitch, TweenInfo.new(0.2), {Position = UDim2.new(0, (state and ToggleSwitch.Size.X.Offset / 2 or 0), 0, 0), BackgroundColor3 = (state and Color3.fromRGB(0, 0, 0 ) or Color3.fromRGB(0, 0, 0))}):Play()
